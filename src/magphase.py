...
def ola(m_frm, v_pm, win_func=None):
    ...
    # Cut beginning:
    v_sig = v_sig[int(frmlen/2 - v_pm[0]):]
...
def get_shifts_and_frm_locs_from_const_shifts(v_shift_c_rate, frm_rate_ms, fs, interp_type='linear'):
    ...
    for i_vr in range(len(v_shift_vr)-1,0, -1):
        #print(i_vr)
